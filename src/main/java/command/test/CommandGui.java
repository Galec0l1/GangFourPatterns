...
public class CommandGui implements ActionListener, LocationEditor{
    ...
    public void createGui(){
        mainFrame = new JFrame("test.Command Pattern Example");
        Container content = mainFrame.getContentPane();
        content.setLayout(new BoxLayout(content, BoxLayout.Y_AXIS));
        
        editorPanel = new JPanel();
        editorPanel.add(new JLabel("test.Location"));
        ...
        update = new JButton("Update test.Location");
        undo = new JButton("Undo test.Location");
        redo = new JButton("Redo test.Location");
