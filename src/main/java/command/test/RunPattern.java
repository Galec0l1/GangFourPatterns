...
public class RunPattern{
    ...
    public static void main(String [] arguments){
        System.out.println("Example for the test.Command pattern");
        System.out.println();
        System.out.println("This sample will use a command class called");
        System.out.println(" test.ChangeLocationCommand to update the location");
        System.out.println(" of an test.Appointment object.");
        System.out.println("The test.ChangeLocationCommand has the additional");
        ...
        System.out.println("Creating an test.Appointment for use in the demo");
        ...
        System.out.println("Creating the test.ChangeLocationCommand");
